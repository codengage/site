      ...
      <div className="mx-auto h-auto">
        ...
        <div 
          ...
          <div className="w-auto h-auto mx-20px flex content-between flex-wrap font-display text-14 text-black-1">
              <Link className="w-full pt-6px pb-6px border-b border-black-9 inline-flex" to="/#empresa"><img src="icons/icon-play.svg" alt="icon list"/>&nbsp;Empresa</Link>
              <Link className="w-full pt-6px pb-6px border-b border-black-9 inline-flex" to="/#servicos"><img src="icons/icon-play.svg" alt="icon list"/>&nbsp;Serviços</Link>
              <Link className="w-full pt-6px pb-6px border-b border-black-9 inline-flex" to="/#clientes"><img src="icons/icon-play.svg" alt="icon list"/>&nbsp;Clientes</Link>
              <Link className="w-full pt-6px pb-6px border-b border-black-9 inline-flex" to="/#testemunho"><img src="icons/icon-play.svg" alt="icon list"/>&nbsp;Testemunho</Link>
              <Link className="w-full pt-6px pb-6px border-b border-black-9 inline-flex" to="/#talentos"><img src="icons/icon-play.svg" alt="icon list"/>&nbsp;Talentos</Link>
              <Link className="w-full pt-6px pb-6px border-b border-black-9 inline-flex" to="/#contato"><img src="icons/icon-play.svg" alt="icon list"/>&nbsp;Contato</Link>
