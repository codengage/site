          ...
          <div className="w-auto mx-20px pb-203px lg:pb-54px lg:inline-flex lg:justify-between">
            ...
            <div className="w-full lg:w-auto justify-between inline-flex h-148px mt-29px lg:mt-0 lg:mb-0">
              ...
              <div className="c-grid w-82px lg:h-full lg:ml-40px xl:ml-67-53px font-display text-14 text-cian-3">
                <Link className="inline-flex no-outline on-focus" to="/#empresa">
                  <img src="icons/icon-play-cian.svg" alt="icon list" />
                  &nbsp;Empresa
                </Link>
                <Link className="inline-flex no-outline on-focus" to="/#servicos">
                  <img src="icons/icon-play-cian.svg" alt="icon list" />
                  &nbsp;Serviços
                </Link>
                <Link className="inline-flex no-outline on-focus" to="/#clientes">
                  <img src="icons/icon-play-cian.svg" alt="icon list" />
                  &nbsp;Clientes
                </Link>
                <Link className="inline-flex no-outline on-focus" to="/#testemunho">
                  <img src="icons/icon-play-cian.svg" alt="icon list" />
                  &nbsp;Testemunho
                </Link>
                <Link className="inline-flex no-outline on-focus" to="/#talentos">
                  <img src="icons/icon-play-cian.svg" alt="icon list" />
                  &nbsp;Talentos
                </Link>
                <Link className="inline-flex no-outline on-focus" to="/#contato">
                  <img src="icons/icon-play-cian.svg" alt="icon list" />
                  &nbsp;Contato
                </Link>
              </div>
