    ...
    <section className="h-full bg-white pt-30px lg:pt-40px pb-30px lg:pb-60px">
      <div className="container lg:max-w-1065 mx-auto">
        ...
        <div className="lg:max-w-980 xl:w-817px mx-auto text-center mt-30px lg:mt-25px lg:mb-53-23px">
          <p className="text-14 md:text-18 font-display text-black-3 leading-tight mx-20px">
        ...
        <div className="max-w-380 sm:max-w-full lg:inline-flex lg:justify-between w-full h-auto mx-auto">
          <div className="sm:inline-flex lg:flex h-auto lg:w-307px mt-30px lg:mt-0 md:content-between lg:flex-wrap mx-20px">
            <img className="md:float-left w-full md:w-auto" src="/imgs/foto1.png" alt="foto Felix Rode" />
            <div className="px-5px md:float-right md:px-20px lg:px-0">
              <p className="text-14 font-display text-center lg:text-left leading-130 md:leading-105 mt-30px">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
              <div className="w-auto font-semibold text-center lg:text-left mt-20px mb-20px lg:mb-0">
          ...
          <div className="sm:inline-flex lg:flex h-auto lg:w-307px mt-30px lg:mt-0 md:content-between lg:flex-wrap mx-20px">
            <img className="md:float-left w-full md:w-auto" src="/imgs/foto2.png" alt="foto Samantha Firman" />
            <div className="px-5px md:float-right md:px-20px lg:px-0">
              <p className="text-14 font-display text-center lg:text-left leading-130 md:leading-105 mt-30px">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
              <div className="w-auto font-semibold text-center lg:text-left mt-20px mb-20px lg:mb-0">
          ...
          <div className="sm:inline-flex lg:flex h-auto lg:w-307px mt-30px lg:mt-0 md:content-between lg:flex-wrap mx-20px">
            <img className="md:float-left w-full md:w-auto" src="/imgs/foto3.png" alt="foto Samantha Firman" />
            <div className="px-5px md:float-right md:px-20px lg:px-0">
              <p className="text-14 font-display text-center lg:text-left leading-130 md:leading-105 mt-30px">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
              <div className="w-auto font-semibold text-center lg:text-left mt-20px mb-20px lg:mb-0">
                <p className="text-cian-1 text-16">Samantha Firman</p>
