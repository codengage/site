...
function secCodengage() {
  ...
  return (
    <section className="bg-white h-auto">
      ...
      <div className="h-auto xl:h-677px md:w-full bg-cover" style={{ backgroundImage: 'url(/imgs/background_full.svg)' }}>
        <div className="lg:w-581px h-full mx-auto max-w-366 md:max-w-480 lg:max-w-677 bg-cian-1 opacity-95">
          <div className="h-full ml-36-90px md:ml-67px mr-23-48px md:mr-42-63px md:pt-33-28px lg:pt-60-42px">
            ...
            <div className="h-139-31px md:h-213px mb-28-22px lg:mb-50px text-left md:leading-130 lg:leading-normal text-16 md:text-24 mx-auto">
